...
describe('Insert OR REPLACE Query', () => {

  test('builds and renders INSERT OR REPLACE query with named parameters', () => {
  ...
  test('builds and renders INSERT OR REPLACE query with named parameters using Shorthand API', () => {
